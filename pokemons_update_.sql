DROP TABLE pokemons_update;

CREATE TABLE pokemons_update (
...
INSERT INTO pokemons_update(nome, codigo, categoria, descricao, altura, peso, hp, ataque, defesa, especial_ataque, especial_defesa, velocidade) VALUES
...
SELECT * FROM pokemons_update

--Mudar Valor da categoria para seed entre 51 e 99;
UPDATE pokemons_update SET categoria = 'Seed' WHERE codigo >50 AND codigo <100 

--Mudar ataque para 29 nos pokemons que contem inj;
UPDATE pokemons_update SET ataque = 29 WHERE nome LIKE '%inj%'

--Mudar velocidade para 2;
UPDATE pokemons_update SET velocidade = 2 WHERE velocidade = 5

--Mudar categoria para manipule, no pokemon 100
UPDATE pokemons_update SET categoria = 'Manipule' WHERE codigo = 100

--Mudar primeira letra de R para C;
UPDATE pokemons_update SET nome  = 'C%' WHERE nome LIKE 'R%'

-- Trocar altura para 0.51, e peso 0.7 quando altura for 0.5
UPDATE pokemons_update SET altura  = 0.51, peso = 0.7 WHERE altura = 0.5
